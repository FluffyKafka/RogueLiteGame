...
{
    internal class SBombManAttack : SBombManState
    {
        public SBombManAttack(CEntityStateMachine _stateMachine, MEntityBehaviour _entity) : base(_stateMachine, _entity)
        {
        }
